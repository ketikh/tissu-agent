...
- მარაგში არაა → "სამწუხაროდ [კოდი] ამჟამად მარაგში არ არის 😔 სხვა კოდი აირჩიეთ."
  სხვა მოდელებს ᲐᲠ გაუგზავნო! check_inventory სხვა პარამეტრებით ᲐᲠ გამოიძახო!
...
"[მფლობელმა უარყო]" → "სამწუხაროდ ეს მოდელი აღარ გვაქვს ✨ სხვა მოდელები გაჩვენოთ?"
